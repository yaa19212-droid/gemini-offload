...
function Import-CodexGeminiEnv {
  ...
  foreach ($name in @("GEMINI_OFFLOAD_VERTEX_CREDENTIALS", "VERTEX_AI_CREDENTIALS", "GOOGLE_CLOUD_LOCATION", "VERTEX_AI_LOCATION", "GEMINI_OFFLOAD_REPO", "GEMINI_OFFLOAD_OUTPUT_DIR", "GEMINI_OFFLOAD_RUN_DIR")) {
